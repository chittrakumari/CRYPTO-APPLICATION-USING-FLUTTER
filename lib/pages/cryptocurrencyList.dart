                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          color: (pricedata["${currency_data[index].currency_name}symbol"]=='BTC')?Colors.amber[300]:(pricedata["${currency_data[index].currency_name}symbol"]=='DOGE')?Colors.lightGreen[300]: (pricedata["${currency_data[index].currency_name}symbol"]=='ETH')?Colors.purple[100]:(pricedata["${currency_data[index].currency_name}symbol"]=='USDT')?Colors.teal[100]:Colors.grey[200],
                          ...
                          child: Padding(
                            ...
                            child:ListTile(
                              ...
                              /*leading:
                                  ...
                                  IconButton(
                                    // Bitcoin
                                    icon: new Icon(CryptoFontIcons.ADC), onPressed: () {  },
                                  ),*/
                        ...
                        child:Row(
                                children: [
                                   pricedata["${currency_data[index].currency_name}symbol"]=='BTC'? CircleAvatar (

                                     child:new IconButton(icon: new Icon(CryptoFontIcons.BTC,
                                ...
                                onPressed: () {  },
                                     ...
                                     radius: 25.0,
                                    ):(pricedata["${currency_data[index].currency_name}symbol"]=='ETH')?CircleAvatar (child:new IconButton(icon: new Icon(CryptoFontIcons.ETH,
                                     size: 35.0,
                                   ...
                                   ):(pricedata["${currency_data[index].currency_name}symbol"]=='USDT')?CircleAvatar (child:new IconButton(icon: new Icon(CryptoFontIcons.USDT,
                                     size: 35.0,
                                     ...
                                     radius: 25.0,
                                   ):(pricedata["${currency_data[index].currency_name}symbol"]=='ADA')?CircleAvatar(
                                     radius: 25.0,
                                     //backgroundColor: Colors.white,
                                     backgroundImage: AssetImage('assets/ADA.jpg'),
                                   ):(pricedata["${currency_data[index].currency_name}symbol"]=='DOGE')?CircleAvatar (child:new IconButton(icon: new Icon(CryptoFontIcons.DOGE,
                                     size: 35.0,
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child:TranslationAnimatedWidget(
                                        enabled: true, //update this boolean to forward/reverse the animation
                                        values: [
                                          Offset(0, 280), // disabled value value
                                        ...
                                        currency_subscribed_data.addAll(
                                          ...
                                          '${currency_data[index].currency_name}':
                                            ...
                                            'price_in_INR': pricedata[
                                                "${currency_data[index].currency_name}price_in_INR"],
                                                'symbol':pricedata["${currency_data[index].currency_name}symbol"],
                                                'sign':pricedata["${currency_data[index].currency_name}sign"],
                                                'changePercent24Hr': pricedata["${currency_data[index].currency_name}changePercent24Hr"],
                                          }
                                        });
                                      },
                                      color: Colors.deepPurple,
